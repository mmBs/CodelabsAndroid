...
public class NotesServiceApiImpl implements NotesServiceApi {
  ...
  @Override public void getAllNotes(final NotesServiceCallback callback) {
  ...
  @Override public void getNote(final String noteId, final NotesServiceCallback callback) {
