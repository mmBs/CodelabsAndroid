...
public class InMemoryNotesRepository implements NotesRepository {
  ...
  @Override public void getNotes(@NonNull final LoadNotesCallback callback) {
  ...
  @Override public void saveNote(@NonNull Note note) {
    checkNotNull(note);
  ...
  public void getNote(@NonNull final String noteId, @NonNull final GetNoteCallback callback) {
    ...
    mNotesServiceApi.getNote(noteId, new NotesServiceApi.NotesServiceCallback<Note>() {
      @Override public void onLoaded(Note note) {
