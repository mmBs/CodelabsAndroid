...
public class AddNotePresenter implements AddNoteContract.UserActionsListener {
  ...
  @NonNull private final NotesRepository mNotesRepository;
  @NonNull private final AddNoteContract.View mAddNoteView;
  @NonNull private final ImageFile mImageFile;

  public AddNotePresenter(@NonNull NotesRepository notesRepository,
      @NonNull AddNoteContract.View addNoteView, @NonNull ImageFile imageFile) {
    mNotesRepository = checkNotNull(notesRepository);
    mAddNoteView = checkNotNull(addNoteView);
    mImageFile = imageFile;
  }

  @Override public void saveNote(String title, String description) {
  ...
  @Override public void takePicture() throws IOException {
  ...
  @Override public void imageCaptureFailed() {
    captureFailed();
  }
