...
public class NotesFragment extends Fragment implements NotesContract.View {
  ...
  @Nullable @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    tvEmptyListText = root.findViewById(R.id.tvEmptyListText);
  ...
  NoteItemListener mItemListener = new NoteItemListener() {
    @Override public void onNoteClick(Note clickedNote) {
      mActionsListener.openNoteDetails(clickedNote);
    }
  };

  @Override public void setProgressIndicator(final boolean active) {
  ...
  @Override public void showNoteDetailUi(String noteId) {
  ...
  @Override public void setEmptyListText(boolean isEmptyList) {
    tvEmptyListText.setVisibility(isEmptyList ? View.VISIBLE : View.GONE);
  }
