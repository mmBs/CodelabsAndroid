...
public class AddNoteFragment extends Fragment implements AddNoteContract.View {
  ...
  @Override public void onActivityCreated(Bundle savedInstanceState) {
    ...
    fab.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        mActionListener.saveNote(mTitle.getText().toString(), mDescription.getText().toString());
      }
    });
  }
  ...
  @Override public void showNotesList() {
  ...
  @Override public void showImagePreview(@NonNull String imageUrl) {
