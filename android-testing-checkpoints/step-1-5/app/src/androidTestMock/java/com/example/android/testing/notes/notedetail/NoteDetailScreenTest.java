 ...
 */
@RunWith(AndroidJUnit4.class) @LargeTest public class NoteDetailScreenTest {
   ...
   */
  @Rule public ActivityTestRule<NoteDetailActivity> mNoteDetailActivityTestRule =
      new ActivityTestRule<>(NoteDetailActivity.class, true /* Initial touch mode  */, false /* Lazily launch activity */);
   ...
   */
  @Before public void intentWithStubbedNoteId() {
  ...
  @Test public void noteDetails_DisplayedInUi() throws Exception {
