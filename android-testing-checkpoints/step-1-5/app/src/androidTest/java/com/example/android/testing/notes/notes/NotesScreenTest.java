 ...
 */
@RunWith(AndroidJUnit4.class) @LargeTest public class NotesScreenTest {
  ...
  @Test public void clickAddNoteButton_opensAddNoteUi() throws Exception {
  ...
  @Test public void addNoteToNotesList() throws Exception {
    //fail("Implement step 7");
